...
class BaseServerMiddleware:
    ...
    def apply(self, method: Callable[[Message, RpcContext], Message]) -> Callable[[Message, RpcContext], Message]:
        @wraps(method)
        def _wrapped(request: Message, context: RpcContext) -> Message:
            try:
    ...
    def _process_request(self, request: Message, context: RpcContext) -> Message:
    ...
    def _process_response(self, response: Message, request: Message, context: RpcContext) -> Message:
    ...
    def _process_finally(self, request: Message, context: RpcContext) -> None:
    ...
    def process_request(self, request: Message, context: RpcContext) -> Message:
        return request

    # noinspection PyUnusedLocal,PyMethodMayBeStatic
    def process_response(self, response: Message, request: Message, context: RpcContext) -> Message:
        return response
    ...
    def process_finally(self, request: Message, context: RpcContext) -> None:
        pass
